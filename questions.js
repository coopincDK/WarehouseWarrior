...
const questionBank = [
    {
        ...
        wmsFact: "WMS-boost: digitalt flowkort over dit lager. Effekt: du ser flaskehalse i realtid uden at gå rundt."
    },
    {
        level: 1,
        category: "Lagerindretning",
        ...
        proTip: "Marker dine tre zoner med farvet tape på gulvet: grøn for modtagelse, gul for lager, rød for afsendelse.",
        wmsFact: "WMS-boost: styring af alle tre zoner fra modtagelse til afsendelse. Effekt: intet trin glemmes."
    },
    {
        level: 1,
        category: "Lagerindretning",
        ...
        proTip: "Tjek altid følgesedlen mod den fysiske levering. Tæl kolli og noter afvigelser med det samme.",
        wmsFact: "WMS-boost: automatisk afstemning af indkøb mod følgesedler. Effekt: afvigelser fanges ved modtagelse."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        proTip: "Hav altid 2-3 kassestørrelser klar ved pakkebordet. Den rigtige kasse sparer både emballage og fragt.",
        wmsFact: "WMS-boost: automatisk valg af billigste fragtløsning. Effekt: lavere fragtomkostning per pakke."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        wmsFact: "WMS-boost: digital ordrekø ved pakkebordet. Effekt: pakkeren ser altid næste ordre uden ventetid."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        wmsFact: "WMS-boost: gennemløbstid per pakkestation. Effekt: du ser hvilke borde der bremser flowet."
    },
    {
        level: 3,
        category: "Lagerindretning",
        ...
        proTip: "Film en pluk-rute og se den bagefter, du opdager ting du aldrig ser i hverdagen. Er dine medarbejdere med på det.",
        wmsFact: "WMS-boost: sammenligning af plukruter. Effekt: du finder den korteste rute med færrest skridt."
    },
    {
        level: 3,
        category: "Lagerindretning",
        ...
        proTip: "Placer aldrig to varianter af samme vare lige ved siden af hinanden. Brug en tom hylde eller et skillepanel imellem.",
        wmsFact: "WMS-boost: lyd/vibration ved forkert scan. Effekt: plukkeren fanger fejlen før varen forlader hylden."
    },
    {
        level: 4,
        ...
        proTip: "Træk en salgsrapport for de sidste 3 måneder, sortér efter ordrefrekvens, og marker de top 20%. Det er dine A-varer.",
        wmsFact: "WMS-boost: automatisk ABC-analyse på realtidsdata. Effekt: dine A-varer er altid opdaterede."
    },
    {
        level: 4,
        category: "ABC-analyse",
        ...
        proTip: "Gå en tur på lageret og tæl skridt fra A-varerne til pakkebordet. Kan du flytte dem tættere?",
        wmsFact: "WMS-boost: forslag til optimal placering baseret på plukfrekvens. Effekt: A-varer ligger altid bedst."
    },
    {
        level: 5,
        category: "ABC-analyse",
        ...
        proTip: "Sæt en reminder hver 3. måned: gennemgå din ABC-analyse. Varer skifter kategori oftere end du tror.",
        wmsFact: "WMS-boost: tracking af omsætningshastighed per vare. Effekt: du ser når en B-vare bliver A-vare."
    },
    {
        level: 5,
        ...
        proTip: "Start med at samle alle single-line ordrer i én bunke og pluk dem samlet. Det er den nemmeste form for batch-plukning.",
        wmsFact: "WMS-boost: automatisk batch-plukning med optimale ruter. Effekt: ingen manuel sortering af ordrer."
    },
    {
        level: 6,
        category: "Plukkestrategi",
        ...
        proTip: "Tegn din plukkerute på et stykke papir. Går du frem og tilbage? Prøv en U-formet rute i stedet.",
        wmsFact: "WMS-boost: beregning af korteste plukrute. Effekt: færre skridt og hurtigere gennemløb."
    },
    {
        level: 6,
        category: "Plukkestrategi",
        ...
        proTip: "Sortér dine ordrer i single-line og multi-line, før du begynder at plukke. Det sparer tid med det samme.",
        wmsFact: "WMS-boost: automatisk prioritering af hasteordrer. Effekt: same-day ordrer plukkes altid først."
    },
    {
        level: 7,
        category: "Redskaber",
        ...
        proTip: "Lad en kollega dobbelttjekke de 5 mest forvekslede varer manuelt. Skriv dem på en liste ved plukkevognen.",
        wmsFact: "WMS-boost: registrering af lot- og batchnumre ved hvert scan. Effekt: fuld sporbarhed uden papir."
    },
    {
        level: 7,
        category: "Redskaber",
        ...
        proTip: "Mål pluk pr. time i en uge og find gennemsnittet. Det er dit udgangspunkt for forbedringer.",
        wmsFact: "WMS-boost: plukperformance per medarbejder. Effekt: du ser pluk pr. time, fejlrate og distance."
    },
    {
        level: 8,
        ...
        proTip: "Sæt en rød streg eller tape på reolen ved minimum-niveau. Når du kan se stregen, er det tid til at bestille.",
        wmsFact: "WMS-boost: overvågning af min/max i realtid. Effekt: genbestilling sker før du løber tør."
    },
    {
        level: 8,
        category: "Lagerstyring",
        ...
        proTip: "Sæt en rød streg på reolen ved minimum-niveau. Når stregen er synlig, bestil hjem. Simpelt og visuelt.",
        wmsFact: "WMS-boost: alarm ved lav holdbarhed. Effekt: du undgår at sende varer der snart udløber."
    },
    {
        level: 9,
        category: "Lagerstyring",
        ...
        proTip: "Tæl dine A-varer hver uge, B-varer hver måned, og resten kvartalsvis. Skriv det i en fast plan.",
        wmsFact: "WMS-boost: automatisk cyklisk optælling. Effekt: du tæller løbende uden at stoppe driften."
    },
    {
        level: 9,
        category: "Lagerstyring",
        ...
        proTip: "Lav en SKU-konvention i dag: fx BRAND-TYPE-FARVE-STR. Skriv den ned og hæng den ved computeren.",
        wmsFact: "WMS-boost: generering af stregkoder fra SKU-numre. Effekt: alle varer scanbare med ét klik."
    },
    {
        level: 10,
        category: "Pakkefejl",
        ...
        wmsFact: "WMS-boost: beregning af reel omkostning per pakkefejl. Effekt: du ser den sande pris inkl. retur."
    },
    {
        level: 10,
        category: "Pakkefejl",
        ...
        proTip: "Lad én person plukke og en anden pakke og tjekke. Det ekstra øjepar fanger fejl, før pakken forlader lageret.",
        wmsFact: "WMS-boost: automatisk fragtetiket baseret på vægt og mål. Effekt: ingen manuel indtastning."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Hæng en whiteboard-tavle ved udgangen. Skriv ugens fejlscore op, så alle kan se fremgangen.",
        wmsFact: "WMS-boost: logging af alle afvigelser med tidsstempel. Effekt: fejlmønstre dukker op automatisk."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Start en simpel fejllog i et regneark: dato, vare, fejltype, årsag. Gennemgå den hver fredag.",
        wmsFact: "WMS-boost: automatisk hændelseslog med tidsstempler. Effekt: fejlmønstre synlige i dashboards."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Opret en fast returzone med en kasse til hver status: godkendt, defekt, afventer. Behandl returer dagligt.",
        wmsFact: "WMS-boost: automatisk lageropdatering ved godkendt retur. Effekt: webshoppen viser altid korrekt lager."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Notér returårsagen på hver retur: fortrydelse, forkert vare, defekt. Mønstrene viser sig hurtigt.",
        wmsFact: "WMS-boost: tracking af returårsager over tid. Effekt: du opdager produktproblemer før de eskalerer."
    },
    {
        level: 13,
        category: "Svind",
        ...
        proTip: "Tæl A-varer ugentligt med en simpel liste. Det tager 15 minutter og afslører afvigelser tidligt.",
        wmsFact: "WMS-boost: stregkodescanning ved optælling. Effekt: 10x hurtigere tælling med færre fejl."
    },
    {
        level: 13,
        category: "Svind",
        ...
        proTip: "Giv hvert lagerområde en ansvarlig person. Når nogen ejer et område, falder svindet.",
        wmsFact: "WMS-boost: fuld sporbarhed per vare og lokation. Effekt: du ved hvem der sidst rørte en vare."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Mål pakkefejlsprocenten manuelt: antal fejl delt med antal ordrer gange 100. Gør det ugentligt.",
        wmsFact: "WMS-boost: sammenligning af performance på tværs af medarbejdere og ugedage. Effekt: du ser mønstre."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Vælg 3 nøgletal og mål dem ugentligt: pluk pr. time, pakkefejlsprocent og gennemløbstid. Start simpelt.",
        wmsFact: "WMS-boost: automatiske dashboards med nøgletal. Effekt: ingen manuelle regneark, data er altid friske."
    },
    {
        level: 15,
        category: "3PL",
        ...
        proTip: "Lav en simpel tjekliste ved pakkebordet: 1) Tjek vare mod ordre, 2) Tjek antal, 3) Pak, 4) Label.",
        wmsFact: "WMS-boost: integration med 3PL-systemer. Effekt: god datahygiejne gør overgangen smertefri."
    },
    {
        level: 15,
        category: "Lagerstyring",
        ...
        proTip: "Rens dine SKU-numre i dag. Fjern mellemrum, specialtegn og dubletter. Det er fundamentet for alt andet.",
        wmsFact: "WMS-boost: direkte integration med webshop og bogføring. Effekt: lager, salg og regnskab taler sammen."
    },
    {
        level: 1,
        category: "Lagerindretning",
        ...
        proTip: "Spørg dine medarbejdere i dag: 'Hvad irriterer dig mest på lageret?' Svaret er din næste forbedring.",
        wmsFact: "WMS-boost: data om medarbejdernes tidsforbrug per zone. Effekt: flaskehalse synlige med data."
    },
    {
        level: 2,
        category: "Lagerindretning",
    ...
    },
    {
        ...
        proTip: "Test dine kassestørrelser: pak 10 typiske ordrer og se hvor ofte du bruger for stor en kasse.",
        wmsFact: "WMS-boost: automatisk forslag til kassestørrelse. Effekt: pakkeren vælger altid den rigtige kasse."
    },
    {
        level: 4,
        category: "ABC-analyse",
        ...
        proTip: "Gennemgå din ABC-analyse kvartalsvis. En C-vare der pludselig sælger godt, skal flyttes til A-zonen.",
        wmsFact: "WMS-boost: automatisk forslag til omplacering. Effekt: C-varer der sælger som A-varer flyttes hurtigt."
    },
    {
        level: 5,
        category: "ABC-analyse",
        ...
        proTip: "Print din ABC-liste og hæng den ved lageret. Marker A-varer med grøn, B med gul, C med rød.",
        wmsFact: "WMS-boost: automatisk ABC-analyse med løbende opdatering. Effekt: du arbejder aldrig med forældet data."
    },
    {
        level: 6,
        category: "Plukkestrategi",
        ...
        proTip: "Sæt et billede af den rigtige kasse på hver hylde, så pakkeren aldrig er i tvivl om kassestørrelsen.",
        wmsFact: "WMS-boost: kassevalg vist på håndscanner. Effekt: pakkeren ved altid hvilken kasse varen skal i."
    },
    {
        level: 7,
        category: "Plukkestrategi",
        ...
        proTip: "Brug farvede labels til hasteordrer: rød = same-day, gul = næste dag. Synlighed skaber prioritering.",
        wmsFact: "WMS-boost: digital prioritering af hasteordrer. Effekt: hasteordrer rykkes automatisk øverst i køen."
    },
    {
        level: 8,
        category: "Lagerstyring",
        ...
        proTip: "Lav en fast optællingsplan: A-varer mandag, B-varer onsdag, C-varer fredag. Hæng planen synligt.",
        wmsFact: "WMS-boost: automatiseret optællingsplan. Effekt: systemet ved hvornår hver vare sidst blev talt."
    },
    {
        level: 9,
        category: "Lagerstyring",
        ...
        proTip: "Skriv din SKU-konvention ned på ét A4-ark og laminér det. Hæng det ved computeren hvor varer oprettes.",
        wmsFact: "WMS-boost: validering af SKU-formater ved oprettelse. Effekt: ugyldige tegn fanges med det samme."
    },
    {
        level: 10,
        category: "Pakkefejl",
        ...
        proTip: "Med stregkodescanning er belysning stadig vigtig, men scanneren fanger fejlen uanset lysforhold. Det er dit sikkerhedsnet når øjnene svigter."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Hold et 10-minutters tavlemøde hver mandag morgen. Gennemgå ugens tal og vælg én ting at forbedre.",
        wmsFact: "WMS-boost: data direkte til tavlemødet. Effekt: fejlprocent og pluk pr. time klar uden forberedelse."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Lav en returskabelon: dato, ordrenr, vare, årsag, handling. Print den og læg den ved returzonen.",
        wmsFact: "WMS-boost: automatisk returlog ved scanning. Effekt: medarbejderen vælger årsag, data flyder selv."
    },
    {
        level: 13,
        category: "Svind",
        ...
        proTip: "Gå lageret igennem med friske øjne: er der varer uden label? Kasser uden plads? Det er svind der venter.",
        wmsFact: "WMS-boost: scanning ved hver varebevægelse. Effekt: proces-svind elimineres, glemmer du at scanne, stopper flowet."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Mål pluk pr. time i en hel uge. Sammenlign morgen vs. eftermiddag. Forskellen afslører træthed eller flow.",
        wmsFact: "WMS-boost: pluk pr. time per zone og medarbejder. Effekt: du ser præcis hvor tempoet kan øges."
    },
    {
        level: 15,
        category: "Generelt",
        ...
        proTip: "Dokumentér dine processer i dag, selv på papir. Når du vokser, har du et fundament at skalere fra.",
        wmsFact: "WMS-boost: skalerbar platform. Effekt: 50 eller 5.000 ordrer om dagen med samme processer."
    },
    {
        level: 3,
        category: "Lagerindretning",
        ...
        proTip: "Når du modtager varer der allerede er solgt, læg dem direkte i pakkezonen. Spring lageret over.",
        wmsFact: "WMS-boost: automatisk identifikation af cross-dock varer. Effekt: varer der skal videre, springer lageret over."
    },
    {
        level: 4,
        category: "ABC-analyse",
        ...
        proTip: "Sortér din salgsliste efter antal ordrer (ikke omsætning). De varer du plukker oftest, er dine A-varer.",
        wmsFact: "WMS-boost: automatisk ABC-klassificering på realtidsdata. Effekt: A-zonen er altid opdateret."
    },
    {
        level: 6,
        category: "Plukkestrategi",
        ...
        proTip: "Brug en køkkenæg-timer ved pakkebordet. Mål hvor lang tid 10 ordrer tager. Det er dit benchmark.",
        wmsFact: "WMS-boost: automatisk gennemløbstid per ordre. Effekt: sammenligning på tværs af dage og medarbejdere."
    },
    {
        level: 7,
        category: "Redskaber",
        ...
        proTip: "Lav en 'kampagne-tjekliste': ekstra emballage, ekstra labels, bemanding, cut-off tider. Brug den hver gang.",
        wmsFact: "WMS-boost: kampagne-mode med forenklede plukflows. Effekt: højere kapacitet under spidsbelastning."
    },
    {
        level: 8,
        category: "Lagerstyring",
    ...
    },
    {
        ...
        proTip: "Lad pakkeren læse ordrenummeret højt mens de pakker. Det tvinger opmærksomhed og fanger fejl tidligt.",
        wmsFact: "WMS-boost: scan-validering ved pakning. Effekt: pakkefejl under 0,1%, under 1 fejl om ugen."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Lad pakkeren tjekke varen mod ordresedlen højt: 'Vare X, antal 2, check.' Det tvinger opmærksomhed.",
        wmsFact: "WMS-boost: scan-validering erstatter manuelt tjek. Effekt: systemet bekræfter automatisk, ingen tvivl."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Opret en fast returzone med tre kasser: 'Til lager', 'Defekt', 'Afventer beslutning'. Tøm dem dagligt.",
        wmsFact: "WMS-boost: guidet returvurdering trin for trin. Effekt: konsistent behandling uanset medarbejder."
    },
    {
        level: 13,
        category: "Svind",
    ...
    },
    {
        ...
        proTip: "Tjek din returprocent per produktkategori hver måned. Høj retur på én kategori peger på et specifikt problem.",
        wmsFact: "WMS-boost: returprocent per produkt og kategori. Effekt: du ser præcis hvilke varer der returneres mest."
    },
    {
        level: 15,
        category: "Generelt",
        ...
        proTip: "Start med det du har: regneark, labels, faste pladser. Gode processer koster ikke penge, kun disciplin.",
        wmsFact: "WMS-boost: forstærkning af eksisterende processer. Effekt: det du allerede gør godt, bliver endnu bedre."
    },
    {
        level: 5,
        category: "Plukkestrategi",
        ...
        proTip: "Lav en 'før og efter'-måling når du ændrer noget. Uden data ved du ikke om det virkede.",
        wmsFact: "WMS-boost: historiske data automatisk. Effekt: du kan altid sammenligne før og efter en ændring."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Lad pakkeren tjekke varen mod ordresedlen og sige varenummeret højt. Det simple dobbelttjek fanger de fleste fejl.",
        wmsFact: "WMS-boost: scan-validering ved pakning. Effekt: fejlprocent under 0,1%, systemet fanger fejlen før kunden."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Hæng et lamineret kort ved pakkebordet med de 5 mest forvekslede varer og hvordan de adskilles.",
        wmsFact: "WMS-boost: billeder af varer på skærmen. Effekt: pakkeren ser præcis hvilken variant der skal i pakken."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Vælg 3 nøgletal og skriv dem på en whiteboard hver uge. Synlighed skaber fokus og motivation.",
        wmsFact: "WMS-boost: automatiske dashboards med nøgletal. Effekt: fokus på handling i stedet for regneark."
    },
    {
        level: 4,
        category: "ABC-analyse",
    ...
    },
    {
        ...
        proTip: "Gennemgå dine C-varer kvartalsvis. Har de ikke solgt i 6 måneder? Overvej udsalg eller kassation.",
        wmsFact: "WMS-boost: automatisk flagning af varer uden salg. Effekt: dead stock opdages før det binder for meget kapital."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        proTip: "Kør din ABC-analyse på ordrefrekvens, ikke omsætning. En billig vare du plukker 20 gange dagligt er en A-vare.",
        wmsFact: "WMS-boost: sortering af ABC-data på ordrer, enheder og omsætning. Effekt: ét klik giver det fulde billede."
    },
    {
        level: 3,
        category: "Lagerindretning",
        ...
        proTip: "Marker A-zonen tydeligt med skilte og farvet tape. Alle skal vide præcis hvor de vigtigste varer står."
    },
    {
        level: 1,
        category: "Lagerindretning",
        ...
        proTip: "Tjek om dine A-varer stadig er A-varer hver 3. måned. Sæsonudsving kan ændre billedet markant."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        proTip: "Placer aldrig to næsten identiske varer ved siden af hinanden. Brug en tom hylde eller skilleplade imellem."
    },
    {
        level: 3,
        category: "Pakkefejl",
        ...
        proTip: "Sæt et billede af varen på hyldeforkanten. Det hjælper nye medarbejdere og reducerer forvekslingsfejl.",
        wmsFact: "WMS-boost: stregkodescanning eliminerer forveksling. Effekt: forkert vare fanges ved scan, ikke ved kunden."
    },
    {
        level: 5,
        category: "Plukkestrategi",
        ...
        proTip: "Mål din gennemsnitlige plukrute i skridt. Kan du reducere den med 20% ved at flytte 3 varer?"
    },
    {
        level: 5,
        category: "Plukkestrategi",
        ...
        proTip: "Batch-pluk single-line ordrer først. De er hurtigst og giver dig momentum til resten af dagen."
    },
    {
        level: 6,
        category: "Plukkestrategi",
        ...
        proTip: "Lav en fast plukkerute: start ved A-zonen, gå i U-form, slut ved pakkebordet. Aldrig frem og tilbage."
    },
    {
        level: 6,
        category: "Plukkestrategi",
        ...
        proTip: "Sortér ordrer efter antal linjer før pluk. Single-line for sig, multi-line for sig. Det sparer tid."
    },
    {
        level: 7,
        category: "Redskaber",
        ...
        proTip: "Observer dit pakkebord i 30 minutter. Hvor ofte venter pakkeren? Det er din flaskehals.",
        wmsFact: "WMS-boost: måling af ventetid og flaskehalse i realtid. Effekt: du ser præcis hvor flowet stopper."
    },
    {
        level: 7,
        category: "Redskaber",
        ...
        proTip: "Hav altid en ekstra rulle tape og labels klar ved pakkebordet. Mangel på forbrugsstoffer stopper alt."
    },
    {
        level: 8,
        category: "Lagerstyring",
        ...
        proTip: "Beregn din gennemsnitlige daglige salg per A-vare. Gang med leveringstid plus 2 dage. Det er dit minimum.",
        wmsFact: "WMS-boost: dynamisk min/max baseret på omsætningshastighed. Effekt: genbestilling tilpasser sig automatisk."
    },
    {
        level: 8,
        category: "Lagerstyring",
        ...
        proTip: "Sæt rød tape på reolen ved minimum-niveau. Når tapen er synlig, bestil hjem. Ingen regneark nødvendigt.",
        wmsFact: "WMS-boost: automatiske alerts ved minimum-niveau. Effekt: besked på mail eller app, ingen rød streg nødvendig."
    },
    {
        level: 9,
        category: "Lagerstyring",
        ...
        proTip: "Tæl dine 10 vigtigste varer hver mandag morgen. Det tager 10 minutter og afslører problemer tidligt.",
        wmsFact: "WMS-boost: automatisk cyklisk optælling. Effekt: arbejdet fordeles jævnt over ugen uden driftsstop."
    },
    {
        level: 9,
        category: "Svind",
        ...
        proTip: "Lav en 'nul-pluk' liste: varer der ikke er solgt i 90 dage. Gennemgå den månedligt med indkøb.",
        wmsFact: "WMS-boost: automatisk nul-pluks optælling. Effekt: varer der ikke er rørt i en periode, tælles først."
    },
    {
        level: 10,
        category: "Pakkefejl",
        ...
        proTip: "Giv hver vare én fast plads med et tydeligt label. Ingen vare uden adresse, ingen adresse uden vare.",
        wmsFact: "WMS-boost: scan-validering ved pakning. Effekt: pakkefejl falder til under 0,1%."
    },
    {
        level: 10,
        category: "Pakkefejl",
        ...
        proTip: "Lad aldrig den samme person plukke og pakke samme ordre. To øjne fanger fejl som ét par overser.",
        wmsFact: "WMS-boost: scan-validering erstatter dobbelttjek. Effekt: systemet er det ekstra par øjne, altid."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Gennemgå din fejllog hver fredag. Se efter mønstre: samme vare, samme tidspunkt, samme medarbejder?",
        wmsFact: "WMS-boost: automatiske fejlrapporter med mønstre. Effekt: du ser hvilke varer og tidspunkter der fejler."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Lav en onboarding-tjekliste for nye medarbejdere: de 10 vigtigste regler på ét lamineret A4-ark.",
        wmsFact: "WMS-boost: automatisk håndhævelse af standarder. Effekt: systemet guider trin for trin, ingen genveje."
    },
    {
        level: 11,
        category: "Pakkefejl",
        ...
        proTip: "Hæng en visuel tjekliste ved pakkebordet med billeder: 1) Tjek vare, 2) Tjek antal, 3) Pak, 4) Label.",
        wmsFact: "WMS-boost: digital tjekliste med scan-bekræftelse. Effekt: pakken kan ikke lukkes før alle trin er godkendt."
    },
    {
        level: 13,
        category: "Generelt",
        ...
        proTip: "Sørg for god belysning over pakkebordet. Minimum 500 lux. Dårligt lys giver fejl, hovedpine og træthed.",
        wmsFact: "WMS-boost: scanning fanger fejl uanset lysforhold. Effekt: dit sikkerhedsnet virker også kl. 22."
    },
    {
        level: 10,
        category: "Pakkefejl",
    ...
    },
    {
        ...
        proTip: "Opret en fast returzone med klare skilte: 'Modtaget', 'Under vurdering', 'Klar til lager', 'Kasseret'.",
        wmsFact: "WMS-boost: dedikeret returmodul med fuldt flow. Effekt: fra scanning til lager eller kassation i ét system."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Tjek din top-5 returvarer hver måned. Gentagne returer på samme vare peger på et produktproblem, ikke et lagerproblem.",
        wmsFact: "WMS-boost: automatisk flagning af høj returrate. Effekt: produktproblemer opdages før de eskalerer."
    },
    {
        level: 12,
        category: "Returer",
        ...
        proTip: "Mål tiden fra retur modtages til den er behandlet. Sæt et mål: max 24 timer. Det frigør kapital hurtigere.",
        wmsFact: "WMS-boost: måling af behandlingstid per retur. Effekt: du kan sætte mål og følge forbedringer."
    },
    {
        level: 13,
        category: "Svind",
        ...
        proTip: "Adskil svindtyper i din log: procesfejl, beskadigelse, udløb, tyveri. Forskellige årsager kræver forskellige løsninger.",
        wmsFact: "WMS-boost: adskillelse af svindtyper i rapporter. Effekt: du ser om problemet er proces, skade eller tyveri."
    },
    {
        level: 13,
        category: "Svind",
        ...
        proTip: "Lav en fast optællingsplan og hæng den synligt. A-varer ugentligt, B månedligt, C kvartalsvis.",
        wmsFact: "WMS-boost: automatisk rullende optællingsplan. Effekt: daglige lister genereres uden manuel planlægning."
    },
    {
        level: 13,
        category: "Svind",
    ...
    },
    {
        ...
        proTip: "Beregn din pakkefejlsprocent ugentligt: antal fejl delt med antal ordrer gange 100. Hæng tallet synligt.",
        wmsFact: "WMS-boost: pakkefejlsprocent i realtid på dashboard. Effekt: du reagerer med det samme når tallet stiger."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Sæt et mål for pakkefejlsprocenten og gør det synligt. Under 1% er godt, under 0,5% er fremragende.",
        wmsFact: "WMS-boost: automatisk beregning af pakkefejlsprocent. Effekt: alerts når grænseværdien overskrides."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Mål pluk pr. time per zone, ikke kun samlet. Forskellen afslører hvor dit layout kan forbedres.",
        wmsFact: "WMS-boost: pluk pr. time per medarbejder og zone. Effekt: du ser præcis hvor tempoet kan forbedres."
    },
    {
        level: 15,
        category: "Nøgletal",
        ...
        proTip: "Beregn hvor meget kapital der er bundet i varer der ikke har solgt i 6 måneder. Tallet overrasker ofte.",
        wmsFact: "WMS-boost: automatisk beregning af bundet kapital. Effekt: alerts når langsomme varer binder for meget."
    },
    {
        level: 15,
        category: "Nøgletal",
        ...
        proTip: "Gennemgå dine C-varer kvartalsvis. Sæt dem på udsalg, bundl dem med A-varer, eller kassér dem.",
        wmsFact: "WMS-boost: automatisk identifikation af dead stock. Effekt: forslag til udsalg eller kassation."
    },
    {
        level: 8,
        category: "Fragt",
        ...
        proTip: "Vej en typisk pakke og mål den. Sammenlign faktisk vægt med volumenvægt. Betaler du for luft?",
        wmsFact: "WMS-boost: automatisk beregning af volumenvægt. Effekt: forslag til billigste fragtløsning per pakke."
    },
    {
        level: 8,
        category: "Emballage",
        ...
        proTip: "Hav max 3-4 kassestørrelser. Flere størrelser giver forvirring, færre giver for meget luft i pakken.",
        wmsFact: "WMS-boost: automatisk forslag til kassestørrelse. Effekt: pakkeren vælger altid den mindste passende kasse."
    },
    {
        level: 9,
        category: "Fragt",
        ...
        proTip: "Sammenlign fragtpriser fra mindst 2 transportører hvert halvår. Loyalitet er fint, men det skal kunne betale sig.",
        wmsFact: "WMS-boost: direkte integration med fragtportaler. Effekt: fragtetiketten printes automatisk, ingen copy-paste."
    },
    {
        level: 9,
        category: "Fragt",
        ...
        proTip: "Beregn din reelle fragtomkostning per ordre, inkl. emballage og tid. Det er ofte højere end du tror.",
        wmsFact: "WMS-boost: automatisk beregning af ordreomkostning. Effekt: du ser den sande pris inkl. pluk, pak og fragt."
    },
    {
        level: 15,
        category: "Fragt",
        ...
        proTip: "Sæt din fri fragt-grænse så den matcher din gennemsnitlige ordreværdi plus 15-20%. Det øger kurvestørrelsen.",
        wmsFact: "WMS-boost: analyse af ordredata for fri fragt-grænse. Effekt: du finder den optimale grænse baseret på reelle tal."
    },
    {
        level: 3,
        category: "Emballage",
        ...
        proTip: "Forhandl fragtpriser baseret på volumen, ikke enkeltpakker. Saml data for 3 måneder og brug det som argument."
    },
    {
        level: 3,
        category: "Emballage",
        ...
        proTip: "Pak altid den mindste passende kasse. Volumenvægt betyder at luft i pakken koster reel fragt."
    },
    {
        level: 15,
        category: "Kampagner",
        ...
        proTip: "Lav en kampagne-tjekliste 2 uger før: ekstra emballage, bemanding, cut-off tider, kommunikation til teamet.",
        wmsFact: "WMS-boost: kampagne-mode med automatisk prioritering. Effekt: selv vikarer kan plukke effektivt under pres."
    },
    {
        level: 15,
        category: "Kampagner",
    ...
    },
    {
        ...
        proTip: "Tilføj et personligt touch i pakken: en håndskrevet seddel, en slik, eller et visitkort. Det koster næsten intet.",
        wmsFact: "WMS-boost: automatisk tilføjelse af kampagne-flyers. Effekt: samples og flyers baseret på ordreindhold."
    },
    {
        level: 15,
        category: "3PL",
        ...
        proTip: "Mål din genbestillingsrate. Kunder der køber igen er beviset på at din pakke- og leveringsoplevelse virker."
    },
    {
        level: 15,
        category: "3PL",
        ...
        proTip: "Lav en 'unboxing-test': bestil fra dig selv og oplev pakken som kunden. Hvad ville du forbedre?"
    },
    {
        level: 3,
        category: "ABC-analyse",
        ...
        proTip: "Lav en fast morgenrutine: tjek ordrer, prioritér hasteordrer, fordel opgaver. 10 minutter der sætter dagen."
    },
    {
        level: 4,
        category: "ABC-analyse",
        ...
        proTip: "Dokumentér dine processer med billeder, ikke kun tekst. En fotoserie af korrekt pakning siger mere end 1000 ord."
    },
    {
        level: 5,
        category: "ABC-analyse",
        ...
        proTip: "Hold et kort tavlemøde hver uge. Gennemgå ugens tal, fejl og én forbedring. Max 15 minutter."
    },
    {
        level: 6,
        category: "ABC-analyse",
        ...
        proTip: "Gå lageret igennem med en ny medarbejders øjne. Hvad er ulogisk? Hvad mangler skilte? Det er dine forbedringer.",
        wmsFact: "WMS-boost: forslag til placering baseret på salgsdata. Effekt: lagerlayoutet matcher altid det aktuelle salg."
    },
    {
        level: 7,
        category: "ABC-analyse",
        ...
        proTip: "Lav en 'dead stock'-liste: varer uden salg i 6+ måneder. Sæt dem på udsalg eller donér dem. Frigør plads og kapital.",
        wmsFact: "WMS-boost: automatisk identifikation af varer uden salg. Effekt: forslag til udsalg eller fjernelse."
    },
    {
        level: 4,
        category: "Lagerindretning",
    ...
    },
    {
        ...
        proTip: "Lav en fast procedure for nye varer: SKU, foto, vægt, mål, placering. Gør det rigtigt fra dag ét."
    },
    {
        level: 7,
        category: "Lagerindretning",
        ...
        proTip: "Test din emballage: drop-test fra 1 meters højde. Hvis varen overlever, er emballagen god nok."
    },
    {
        level: 3,
        category: "ABC-analyse",
        ...
        proTip: "Mål afstanden fra din mest solgte vare til pakkebordet. Kan du halvere den? Det sparer hundredvis af skridt dagligt."
    },
    {
        level: 4,
        category: "ABC-analyse",
        ...
        proTip: "Lav en 'fejl af ugen'-gennemgang. Ikke for at finde syndebukke, men for at finde procesfejl der kan fixes."
    },
    {
        level: 5,
        category: "ABC-analyse",
        ...
        proTip: "Sæt et mål for gennemløbstid: fra ordre modtaget til pakke klar. Mål det og gør det synligt."
    },
    {
        level: 6,
        category: "ABC-analyse",
        ...
        proTip: "Lav en fast returprocedure: modtag, tjek, beslut, opdater lager. Hæng den som plakat i returzonen."
    },
    {
        level: 4,
        category: "Lagerindretning",
        ...
        proTip: "Tæl dine A-varer ugentligt. Afvigelser over 2% skal undersøges med det samme."
    },
    {
        level: 5,
        category: "Lagerindretning",
        ...
        proTip: "Beregn din svindprocent månedligt: kasserede varer delt med total lagerbeholdning. Hold den under 1%."
    },
    {
        level: 6,
        category: "Lagerindretning",
        ...
        proTip: "Lav en 'quick win'-liste: 5 ting du kan forbedre i dag uden at bruge penge. Start med den nemmeste."
    },
    {
        level: 5,
        category: "Lagerindretning",
        ...
        proTip: "Lav en 'velkomstpakke' til nye medarbejdere: lamineret kort med de 10 vigtigste regler og et lagerkort."
    },
    {
        level: 6,
        category: "Plukkestrategi",
    ...
    },
    {
        ...
        proTip: "Mål din ordregennemløbstid fra modtagelse til afsendelse. Sæt et mål og gør det synligt for teamet."
    },
    {
        level: 7,
        category: "Plukkestrategi",
        ...
        proTip: "Lav en 'hvad hvis'-plan for travle perioder: hvem gør hvad, hvornår skifter vi til ekstra bemanding?"
    },
    {
        level: 5,
        category: "Plukkestrategi",
        ...
        proTip: "Gennemgå dine fragtaftaler hvert halvår. Volumen ændrer sig, og det bør dine priser også."
    },
    {
        level: 4,
        category: "Redskaber",
        ...
        proTip: "Pak en prøveordre og vej den. Sammenlign med volumenvægt. Betaler du for luft? Skift kassestørrelse."
    },
    {
        level: 6,
        category: "Redskaber",
        ...
        proTip: "Lav en fast 'kampagne-debrief' efter hver stor kampagne. Hvad gik godt? Hvad skal vi ændre næste gang?"
    },
    {
        level: 5,
        category: "Redskaber",
        ...
        proTip: "Tilføj en lille overraskelse i pakken ved første køb: en seddel, en rabatkode, eller en sample. Det skaber loyalitet."
    },
    {
        level: 4,
        category: "Lagerstyring",
    ...
    },
    {
        ...
        proTip: "Lav en simpel 'fejlkort'-boks ved pakkebordet. Anonyme kort med fejl og forslag. Gennemgå dem ugentligt."
    },
    {
        level: 6,
        category: "Lagerstyring",
        ...
        proTip: "Dokumentér din modtagelsesproces: tæl, tjek mod følgeseddel, mærk, placer. Hæng den som plakat."
    },
    {
        level: 7,
        category: "Lagerstyring",
        ...
        proTip: "Rens dine SKU-numre kvartalsvis. Fjern dubletter, ret stavefejl, og slet varer der ikke længere sælges.",
        wmsFact: "WMS-boost: krav om rene, unikke SKU-numre. Effekt: god datahygiejne i dag gør WMS-implementering nem."
    },
    {
        level: 6,
        category: "Pakkefejl",
        ...
        proTip: "Beregn hvad én pakkefejl reelt koster: returfragt, ny forsendelse, tid, goodwill. Brug tallet til at motivere.",
        wmsFact: "WMS-boost: automatisk beregning af pakkefejlomkostning. Effekt: du ser den sande pris inkl. returfragt."
    },
    {
        level: 7,
        category: "Pakkefejl",
        ...
        proTip: "Start en simpel fejllog i dag. Bare dato, vare og fejltype. Mønstre viser sig allerede efter 2 uger.",
        wmsFact: "WMS-boost: automatisk hændelseslog med bruger-ID. Effekt: fejlmønstre dukker op i dashboards."
    },
    {
        level: 5,
        category: "Pakkefejl",
        ...
        proTip: "Lav en fast procedure for modtagelse: 1) Tæl kolli, 2) Tjek mod ordre, 3) Mærk, 4) Placer. Altid i den rækkefølge."
    },
    {
        level: 6,
        category: "Pakkefejl",
        ...
        proTip: "Sæt et billede af korrekt pakning ved pakkebordet for dine 10 mest solgte varer. Visuelt slår tekst."
    },
    {
        level: 5,
        category: "Pakkefejl",
        ...
        proTip: "Lav en 'retur-analyse' månedligt: top 5 returvarer, årsager, og hvad I kan gøre for at reducere dem."
    },
    {
        level: 6,
        category: "Returer",
        ...
        proTip: "Opret en fast returlokation på lageret. Returer der flyder rundt, bliver til svind og datafejl.",
        wmsFact: "WMS-boost: fast returlokation med automatiske returordrer. Effekt: intet forsvinder i limbo."
    },
    {
        level: 7,
        category: "Returer",
        ...
        proTip: "Hold et kort møde efter hver stor kampagne. Tre spørgsmål: Hvad virkede? Hvad fejlede? Hvad ændrer vi?"
    },
    {
        level: 7,
        category: "Returer",
        ...
        proTip: "Mål din 'ordre til dør'-tid: fra kunden klikker 'køb' til pakken er afsendt. Det er din vigtigste KPI."
    },
    {
        level: 7,
        category: "Svind",
        ...
        proTip: "Log kasserede varer separat fra returer. Det er to forskellige svindtyper med forskellige løsninger.",
        wmsFact: "WMS-boost: separat tracking af kassation og 2. sortering. Effekt: du ser præcis hvad der kasseres vs. sælges."
    },
    {
        level: 6,
        category: "Svind",
    ...
    },
    {
        ...
        proTip: "Lav en simpel log ved hver station: modtagelse, pluk, pakning. Bare et kryds på en liste giver sporbarhed.",
        wmsFact: "WMS-boost: scanning ved hver varebevægelse. Effekt: processfejl elimineres, systemet stopper ved fejl."
    },
    {
        level: 6,
        category: "Nøgletal",
    ...
    },
    {
        ...
        proTip: "Lav en 'nøgletal-tavle' ved indgangen: pluk pr. time, fejlprocent, gennemløbstid. Opdatér den ugentligt."
    },
    {
        level: 8,
        category: "Nøgletal",
        ...
        proTip: "Mål både ordrer og linjer pr. time. En ordre med 10 linjer tager længere end 10 single-line ordrer.",
        wmsFact: "WMS-boost: måling af ordrer og linjer pr. time. Effekt: sammenligning på det niveau der giver mening."
    },
    {
        level: 7,
        category: "Nøgletal",
        ...
        proTip: "Indfør en 'buddy-ordning' for nye medarbejdere: en erfaren kollega følger dem den første uge."
    },
    {
        level: 6,
        category: "Fragt",
        ...
        proTip: "Lav en 'sæson-kalender' for dit lager: hvornår skal du op- og nedskalere bemanding og lager?"
    },
    {
        level: 7,
        category: "Fragt",
        ...
        proTip: "Gennemgå din emballage kvartalsvis. Bruger du stadig de rigtige størrelser til dit nuværende sortiment?"
    },
    {
        level: 7,
        category: "Fragt",
        ...
        proTip: "Beregn din fragtomkostning som procent af omsætningen. Over 8-10% bør du genforhandle eller optimere."
    },
    {
        level: 5,
        category: "Emballage",
        ...
        proTip: "Lav en 'kampagne-countdown': 4 uger før, 2 uger før, 1 uge før, dagen før. Hver med sin tjekliste."
    },
    {
        level: 6,
        category: "Emballage",
        ...
        proTip: "Tilføj en QR-kode i pakken der linker til en 'tak for dit køb'-side med returinfo og support."
    },
    {
        level: 7,
        category: "Emballage",
        ...
        proTip: "Hold et 10-minutters standup-møde hver morgen under kampagner. Prioritér, fordel, og løs problemer hurtigt."
    },
    {
        level: 7,
        category: "Kampagner",
        ...
        proTip: "Lav en 'lessons learned'-dokument efter hvert projekt. Det er din organisations hukommelse."
    },
    {
        level: 8,
        category: "Kampagner",
        ...
        proTip: "Sæt faste genbestillingspunkter for emballage: tape, kasser, fyld. Løb aldrig tør midt i en travl dag."
    },
    {
        level: 8,
        category: "Kampagner",
        ...
        proTip: "Mål hvor lang tid det tager at onboarde en ny medarbejder til fuld produktivitet. Kan du halvere det?"
    },
    {
        level: 7,
        category: "Kampagner",
        ...
        proTip: "Lav en 'worst case'-plan: hvad gør I hvis jeres bedste medarbejder er syg på den travleste dag?"
    },
    {
        level: 8,
        category: "3PL",
        ...
        proTip: "Brug farvede kasser til forskellige ordretyper: blå for standard, rød for haste, grøn for abonnement."
    },
    {
        level: 8,
        category: "3PL",
        ...
        proTip: "Indfør en daglig 'walk-through': gå lageret igennem og noter 3 ting der kan forbedres. Gør det til en vane."
    },
    {
        level: 9,
        category: "3PL",
        ...
        proTip: "Lav en simpel 'kapacitetsplan': hvor mange ordrer kan I håndtere per dag med nuværende setup?"
    },
    {
        level: 9,
        category: "3PL",
        ...
        proTip: "Sæt en fast tid for varemodtagelse. Når alle ved hvornår varer kommer, kan resten af dagen planlægges."
    },
    {
        level: 10,
        category: "3PL",
        ...
        proTip: "Lav en 'quick reference'-guide til dit lagersystem: de 10 mest brugte funktioner på ét A4-ark."
    },
    {
        level: 8,
        category: "Generelt",
        ...
        proTip: "Mål din plukpræcision: antal korrekte pluk delt med total antal pluk. Over 99% er målet."
    },
    {
        level: 14,
        category: "Nøgletal",
        ...
        proTip: "Mål gennemløbstid per ordrelinje, ikke kun per ordre. Det afslører om komplekse ordrer bremser flowet.",
        wmsFact: "WMS-boost: automatisk gennemløbstid per ordre. Effekt: du ser præcis hvor i processen tiden bruges."
    },
    {
        level: 6,
        category: "Pakkefejl",
        ...
        proTip: "Lav en returårsag-liste med max 5 valgmuligheder og hæng den ved returzonen. Konsistens starter med simple valg."
    },
    {
        level: 7,
        category: "Returer",
    ...
    },
    {
        ...
        proTip: "Lav en 'lager-audit' kvartalsvis: gennemgå layout, processer og nøgletal. Brug en fast tjekliste."
    },
    {
        level: 8,
        category: "Svind",
        ...
        proTip: "Giv hvert lagerområde en ansvarlig. Når nogen ejer et område, stiger orden og falder svind.",
        wmsFact: "WMS-boost: logging af hvem der sidst håndterede en vare. Effekt: ansvaret er altid klart."
    },
    {
        level: 8,
        category: "Svind",
        ...
        proTip: "Marker midlertidige placeringer tydeligt med 'TEMP'-labels. Midlertidige løsninger bliver ellers permanente.",
        wmsFact: "WMS-boost: digital håndtering af midlertidige flytninger. Effekt: scan til ny lokation, systemet husker."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        proTip: "Lav en 'onboarding-dag' for nye medarbejdere: rundvisning, processer, sikkerhed, og hvem man spørger."
    },
    {
        level: 2,
        category: "Lagerindretning",
        ...
        proTip: "Når varer ankommer der allerede er solgt, send dem direkte til pakning. Spring lageret over og spar tid."
    },
    {
        level: 10,
        category: "Fragt",
        ...
        proTip: "Beregn din gennemsnitlige ordreværdi og fragtomkostning. Fri fragt-grænsen skal ligge over begge."
    },
    {
        level: 12,
        category: "Kampagner",
        ...
        proTip: "Lav en 'efter-kampagne'-tjekliste: indsaml data, hold evalueringsmøde, opdatér processer, arkivér læring."
    },
    {
        level: 13,
        category: "3PL",
        ...
        proTip: "Få din exit-plan på plads FØR du underskriver 3PL-aftalen. Det er nemmere at forhandle inden end efter."
    },
    {
        level: 5,
        category: "Lagerindretning",
        ...
        proTip: "Spred dine A-varer ud over hele A-zonen. Hvis alle står samlet, skaber du kø og frustration."
    },
    {
        level: 9,
        category: "Fragt",
        ...
        proTip: "Saml dine afsendelser til 2-3 faste dage om ugen. Det giver bedre fragtpriser og mere forudsigelig drift."
    },
    {
        level: 11,
        category: "Generelt",
        ...
        proTip: "Vælg kun én ting at forbedre per uge. Gennemfør den 100% før du tager den næste. Konsistens slår ambition."
    },
    {
        level: 9,
        category: "Svind",
        ...
        proTip: "Rotér ansvaret for optælling mellem medarbejdere. Friske øjne finder fejl som rutinen overser."
    },
    {
        level: 3,
        category: "Emballage",
        ...
        proTip: "Sæt prisen på emballagen synligt ved pakkebordet. Når pakkeren ser prisen, vælger de den billigste passende kasse."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Gør nye vikarer til eksperter i én simpel opgave. Specialisering under pres giver færre fejl og højere fart."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Investér i god belysning før dyre systemer. Mange pakkefejl skyldes simpelthen at man ikke kan se ordentligt."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Justér min/max op 2-3 uger før en kampagne. Vent ikke til ugen før, så er det for sent at bestille hjem."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Lav en SKU-konvention og håndhæv den fra dag ét. Dårlig datahygiejne i dag bliver en dyr hovedpine i morgen."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Forhandl din exit-plan ind i kontrakten fra start. Det er ikke mistillid, det er professionalisme."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Giv dine B- og C-zoner samme struktur som A-zonen: faste pladser, labels, og orden. Optælling kræver det."
    },
    {
        level: 13,
        category: "Avanceret",
        ...
        proTip: "Brug returdata aktivt: hvis 'forkert størrelse' er top-årsag, er løsningen på webshoppen, ikke lageret."
    },
    {
        level: 14,
        category: "Avanceret",
        ...
        proTip: "Giv store A-varer en dedikeret palleplads tæt på pakkebordet, men uden for reolerne. Spar reolplads til småvarer."
    },
    {
        level: 14,
        category: "Avanceret",
        ...
        proTip: "Hold hasteordrer ude af batch-pluk. Giv dem en separat, hurtig kanal direkte til pakning."
    },
    {
        level: 14,
        category: "Avanceret",
        ...
        proTip: "Mål om special-emballage øger genkøbsraten. Hvis ikke, er det en udgift, ikke en investering."
    },
    {
        level: 14,
        category: "Avanceret",
        ...
        proTip: "Se altid nøgletal i sammenhæng. Stiger pluk pr. time OG fejlprocenten? Så er den nye proces for stressende."
    },
    {
        level: 14,
        category: "Avanceret",
        ...
        proTip: "Konstante små afvigelser peger på procesfejl, ikke tyveri. Tjek modtagelse og registrering først."
    },
    {
        level: 14,
        category: "Avanceret",
        ...
        proTip: "Sortér altid din ABC-analyse efter antal ordrer, ikke omsætning. Det er plukfrekvensen der bestemmer placering."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "Hvis fejlloggen er tom men returloggen fuld, er problemet kulturen, ikke kvaliteten. Skab tryghed omkring fejl."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "En SLA der måler gennemsnit, skjuler hvem fejlene rammer. Kræv data per kundetype eller ordrekategori."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "Beregn hvor meget kapital der er bundet i C-varer. Det tal motiverer til oprydning mere end noget argument."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "Indfør en fast returproces: modtag, tjek, beslut, opdater. Varer i limbo binder kapital og skaber rod."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "Optimér ABC og batch-pluk manuelt først. Gode processer koster ikke penge, de koster disciplin."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "Adskil altid single-line og multi-line ordrer. Pluk de simple først i ét hurtigt batch, så er halvdelen klaret."
    },
    {
        level: 15,
        category: "Avanceret",
        ...
        proTip: "Hvis tavlemødet er stille, er problemet kulturen. Start med at spørge: 'Hvad irriterede dig mest i denne uge?'"
    },
    {
        level: 11,
        category: "Ekspert",
    ...
    },
    {
        ...
        proTip: "Kræv realtidsadgang til lagerdata i din 3PL-aftale. Uden transparens har du ingen kontrol."
    },
    {
        level: 11,
        category: "Ekspert",
        ...
        proTip: "Hvis pluk pr. time falder efter ABC-optimering, tjek om A-zonen er for tæt. Kø i A-zonen er en klassisk fælde."
    },
    {
        level: 11,
        category: "Ekspert",
        ...
        proTip: "Anerkend altid forslaget, men forklar prioriteringen: lageret optimeres for A-varer, fordi de skaber 80% af aktiviteten."
    },
    {
        level: 11,
        category: "Ekspert",
        ...
        proTip: "Trendvarer skal have midlertidig A-status med lavt minimum. Vær klar til at flytte dem tilbage hurtigt."
    },
    {
        level: 11,
        category: "Ekspert",
        ...
        proTip: "Kend dine egne nøgletal FØR du outsourcer. Uden baseline kan du ikke vurdere om din 3PL performer."
    },
    {
        level: 12,
        category: "Ekspert",
        ...
        proTip: "Observer pakkeprocessen i 15 minutter: tjekker pakkeren reelt, eller nikker de bare? Adfærd slår procedure."
    },
    {
        level: 12,
        category: "Ekspert",
        ...
        proTip: "Når returårsagen er 'forkert størrelse', er løsningen ikke på lageret. Tal med indkøb og marketing."
    },
    {
        level: 12,
        category: "Ekspert",
        ...
        proTip: "Frigør kapital før du investerer i systemer. Fjern dødt lager, og brug pengene på A-varer eller bedre processer."
    },
    {
        level: 12,
        category: "Ekspert",
        ...
        proTip: "Test dit shopsystem under belastning før kampagner. Lagerstatus der ikke opdaterer i realtid giver kaos."
    },
    {
        level: 12,
        category: "Ekspert",
        ...
        proTip: "Beregn den reelle ordreomkostning: pluk, pak, emballage, betaling, fragt. Nogle ordrer koster mere end de indbringer."
    },
    {
        level: 12,
        category: "Ekspert",
        ...
        proTip: "Lav rullende optælling hele året. En stor optælling lige før Black Friday skaber stress og afslører fejl du ikke kan nå at rette."
    },
    {
        level: 13,
        category: "Ekspert",
        ...
        proTip: "Adskil næsten identiske varer fysisk. To ens produkter i forskellig farve ved siden af hinanden er en fejl der venter."
    },
    {
        level: 13,
        category: "Ekspert",
        ...
        proTip: "Mål tid per retursag, ikke kun antal returer. En lav returprocent kan skjule en ekstremt dyr proces."
    },
    {
        level: 13,
        category: "Ekspert",
        ...
        proTip: "Opret en dedikeret zone i varemodtagelsen til kontrollerede varer. Bland aldrig tjekket og utjekket gods."
    },
    {
        level: 13,
        category: "Ekspert",
        ...
        proTip: "En hurtig plukker der skaber rod, koster mere end en langsom der følger systemet. Mål teamets samlede output."
    },
    {
        level: 13,
        category: "Ekspert",
        ...
        proTip: "Pre-pak kampagnebundter som nye SKU-numre. 'Køb 3 betal for 2' bliver ét pluk i stedet for tre."
    },
    {
        level: 13,
        category: "Ekspert",
        ...
        proTip: "En exit-plan i kontrakten er ikke mistillid. Det er en professionel sikring der gavner begge parter."
    },
    {
        level: 14,
        category: "Ekspert",
        ...
        proTip: "Mængderabat skal altid holdes op mod bundet kapital. 10% rabat er intet værd hvis pengene er låst i lager."
    },
    {
        level: 14,
        category: "Ekspert",
        ...
        proTip: "Et simpelt rullefelt ved pakkebordet fjerner afbrydelser. Pakkeren pakker, pakkerne ruller selv væk."
    },
    {
        level: 14,
        category: "Ekspert",
        ...
        proTip: "Store A-varer hører på en dedikeret palleplads tæt på pakkebordet. Spar reolpladsen til de mange små A-varer."
    },
    {
        level: 14,
        category: "Ekspert",
        ...
        proTip: "Sortér ABC efter antal ordrer, ikke antal solgte enheder. 1 ordre med 100 stk er 1 tur. 100 ordrer med 1 stk er 100 ture."
    },
    {
        level: 14,
        category: "Ekspert",
        ...
        proTip: "Kasserede varer SKAL logges. Uregistreret kassation er usynligt svind der ødelægger din lagernøjagtighed."
    },
    {
        level: 14,
        category: "Ekspert",
        ...
        proTip: "Adskil proces-svind og naturligt svind i din log. Proces-svind kan du reducere, naturligt svind skal du budgettere."
    },
    {
        level: 15,
        category: "Ekspert",
        ...
        proTip: "Indfør grundig kvalitetskontrol ved modtagelse af skrøbelige varer. Mange reklamationer starter før varen når hylden."
    },
    {
        level: 15,
        category: "Ekspert",
        ...
        proTip: "Kør din ABC-analyse på de seneste 90 dage, ikke et helt år. Sæsonvarer klassificeres rigtigt i deres lavsæson."
    },
    {
        level: 15,
        category: "Ekspert",
        ...
        proTip: "Med høj medarbejderudskiftning er nedskrevne processer og visuelle tjeklister dit vigtigste værktøj."
    },
    {
        level: 15,
        category: "Ekspert",
        ...
        proTip: "Forudsigelige ordrer kan pre-plukkes i faste batches. Selv én fast ugentlig kunde kan optimeres."
    },
    {
        level: 15,
        category: "Ekspert",
        ...
        proTip: "Indret lageret efter salgsdata, ikke efter produktkategorier. Et lager er en maskine, ikke en butik."
    },
    {
        level: 15,
        ...
        proTip: "Lær af din hurtigste medarbejder: hvad gør de anderledes? Standardisér metoden og tilføj dobbelttjek."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Bedre belysning og tjekliste-holdere er ofte den bedste investering mod fejl. Simpelt, billigt, effektivt."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Hvis din 3PL vil sælge dig 'premium placering' af A-varer, spørg hvorfor det ikke allerede er standard."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Reager på trends med forsigtighed. Bestil i små batches og hold minimum lavt. Trends dør hurtigt."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Et kort ugentligt møde slår et langt månedligt. Hyppighed og konsistens skaber kultur for forbedring."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "A-zonens plads er kostbar. En stor B-vare der optager plads til 10 små A-varer er en dårlig handel."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "En tom fejllog er et faresignal. Undersøg om medarbejderne frygter konsekvenser ved at rapportere fejl."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Varer der ofte sælges sammen kan pre-pakkes som bundle med egen SKU. Ét pluk i stedet for to."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Se aldrig ét nøgletal isoleret. Pluk pr. time er værdiløst hvis fejlprocenten stiger tilsvarende."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "En loyal kunde der klager, er en gave. Løs problemet exceptionelt og brug fejlen til at forbedre processen."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Et simpelt visuelt tavlesystem der bruges af alle, slår et avanceret regneark der kun bruges af chefen."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Hvis pluk er hurtigt men gennemløbstiden lang, er flaskehalsen før eller efter pluk. Tjek pakning og labels."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Vis medarbejderen en udregning i kroner: ekstra kilometer gange løntimer. Data vinder over holdninger."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "God onboarding reducerer pakkefejl og returer. Det er ikke bare HR, det er en direkte investering i bundlinjen."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "10% rabat på emballage lyder godt, men bundet kapital og optaget plads koster ofte mere end besparelsen."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Indfør en 'hittegods-kasse' for løse varer. Fast procedure: find varen i systemet, læg den på plads, log det."
    },
    {
        level: 15,
        category: "Super Ekspert",
        ...
        proTip: "Komplekse multi-line ordrer med mange C-varer har ekstremt høj fejlrisiko. Overvej dobbelttjek på disse."
    },
    {
        level: 15,
        category: "Super Ekspert",
